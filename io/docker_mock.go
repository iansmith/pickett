...
func (_m *MockDockerCli) EmptyOutput(_param0 bool) bool {
	ret := _m.ctrl.Call(_m, "EmptyOutput", _param0)
	ret0, _ := ret[0].(bool)
	return ret0
}

func (_mr *_MockDockerCliRecorder) EmptyOutput(arg0 interface{}) *gomock.Call {
	return _mr.mock.ctrl.RecordCall(_mr.mock, "EmptyOutput", arg0)
}
