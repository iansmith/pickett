...
func (_m *MockIOHelper) Docker() (DockerCli, error) {
	ret := _m.ctrl.Call(_m, "Docker")
	ret0, _ := ret[0].(DockerCli)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

func (_mr *_MockIOHelperRecorder) Docker() *gomock.Call {
	return _mr.mock.ctrl.RecordCall(_mr.mock, "Docker")
}
